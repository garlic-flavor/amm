...
"def": ["", "", "  On Windows"],
"ddoc": ["", "", "  On Windows"],
"dd": ["", "", "  specify the target directory of DDOC(http://dlang.org/spec/ddoc.html)."],
...
o Ubuntu 15.10(x64) x gcc 5.2.1 x dmd 2.070.0 x GNU Make
...
"開発環境:":`
現在、
o Windows Vista(WoW64) x dmd2.070.0 x (dmdに付属の)make
o Ubuntu 15.10(x64) x gcc 5.2.1 x dmd2.070.0 x GNU Make
