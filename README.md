...
__Version:__ 0.169(dmd2.070.0)

__Date:__ 2016-Feb-28 23:36:59
...
- Ubuntu 15.10(x64) x gcc 5.2.1 x dmd 2.070.0 x GNU Make
...
## 開発環境:
現在、
- Windows Vista(WoW64) x dmd2.070.0 x (dmdに付属の)make
- Ubuntu 15.10(x64) x gcc 5.2.1 x dmd2.070.0 x GNU Make
