...
__Version:__ 0.173(dmd2.085.1)
__Date:__ 2019-Apr-15 19:41:54
__Authors:__ KUMA
__License:__ CC0
...
windows          |                       | when this macro is defined, standard settings for windows are chosen.
linux            |                       | when this macro is defined, standard settings for linux are chosen.
...
i                |                       | Amm will set this value. This is same as `-I` option for dmd.
...
- Windows 10(x64) x 2.085.1 x make (of Digital Mars)
- Ubuntu 18.04(on Windows x64) x gcc 7.3.0 x 2.085.1 x GNU Make

## History
- 2019/04/15 ver. 0.173(dmd2.085.1)
    - for linux.
...
i                |                       | AMMが値を設定します。dmdの`-I`オプションの内容と同じです。
